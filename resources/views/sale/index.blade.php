                ...
                <div class="row" ng-controller="SearchItemCtrl">
                    ...
                    <div class="col-md-9">
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>@{{newsaletemp.item_id}}</td><td>@{{newsaletemp.item.item_name}}</td><td>@{{newsaletemp.item.selling_price | number}}</td><td><input type="text" style="text-align:center" autocomplete="off" name="quantity" ng-change="updateSaleTemp(newsaletemp)" ng-model="newsaletemp.quantity" size="2"></td><td>@{{newsaletemp.item.selling_price * newsaletemp.quantity | number}}</td><td><button class="btn btn-danger btn-xs" type="button" ng-click="removeSaleTemp(newsaletemp.id)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></td>
                            </tr>
                        </table>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <p class="form-control-static">GHC <b>@{{sum(saletemp)}}</b></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                            <p class="form-control-static">GHC @{{add_payment - sum(saletemp)  }}</p>
                                            </div>
                                    </div>
